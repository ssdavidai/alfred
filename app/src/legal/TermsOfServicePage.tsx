      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <p>These Terms of Service ("Terms") govern your access to and use of Alfred Black, operated by <strong className="text-white">Ugly Code LLC</strong>, 28 Geary St STE 650 Suite #142, San Francisco, California 94108, United States ("Company," "we," "us," or "our").</p>
          ...
          <section>
            ...
            <p>You must provide a valid email address and verify it to activate your account. You are responsible for maintaining the confidentiality of your credentials and all activity under your account. Notify us immediately at <a href="mailto:help@alfred.black" className="text-blue-400 hover:underline">help@alfred.black</a> if you suspect unauthorized access.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">5. Subscriptions and Payment</h2>
            ...
            <p className="mt-3"><strong className="text-white">Refunds:</strong> We offer a 7-day refund for new subscribers who have not provisioned or meaningfully used their AI instance. After 7 days or first use, subscriptions are non-refundable. Contact <a href="mailto:help@alfred.black" className="text-blue-400 hover:underline">help@alfred.black</a> for refund requests.</p>
            <p className="mt-3"><strong className="text-white">Cancellation:</strong> You may cancel at any time. Your subscription remains active until the end of the billing period. We do not prorate partial months.</p>
            <p className="mt-3"><strong className="text-white">Past due accounts:</strong> Failure to pay may result in suspension of your instance. Data is retained for 30 days following suspension before deletion.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">6. Infrastructure and Instance Provisioning</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">7. Autonomous AI Actions</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">9. API Access</h2>
          ...
          <section>
            ...
            <p>The Alfred Black platform, software, trademarks, and branding are owned by Ugly Code LLC. You retain ownership of all content you input into the Service, including vault data, notes, and credentials.</p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">11. Data and Privacy</h2>
            <p>Your use of the Service is also governed by our <a href="/pp" className="text-blue-400 hover:underline">Privacy Policy</a>, which is incorporated into these Terms by reference. Please review it carefully.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">12. Disclaimers</h2>
            <p className="uppercase text-sm text-gray-400">The Service is provided "as is" and "as available" without warranties of any kind, express or implied, including but not limited to merchantability, fitness for a particular purpose, or non-infringement. We do not warrant that the Service will be uninterrupted, error-free, or free of harmful components.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">13. Limitation of Liability</h2>
            <p>To the maximum extent permitted by applicable law, Ugly Code LLC and its officers, directors, employees, and agents shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of data, profits, or goodwill, arising from your use of or inability to use the Service.</p>
          ...
          <section>
            ...
            <p>You agree to indemnify and hold harmless Ugly Code LLC from any claims, damages, losses, liabilities, costs, and expenses (including reasonable legal fees) arising from: (a) your use of the Service; (b) your violation of these Terms; (c) actions taken by your AI instance using your credentials; or (d) your violation of any third party's rights.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-white mb-3">15. Termination</h2>
            <p>We may suspend or terminate your account immediately if you violate these Terms, engage in fraudulent activity, or if we are required to do so by law. You may terminate your account at any time by canceling your subscription and contacting <a href="mailto:help@alfred.black" className="text-blue-400 hover:underline">help@alfred.black</a>.</p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">17. Changes to Terms</h2>
