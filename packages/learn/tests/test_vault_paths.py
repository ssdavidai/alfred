...
class TestSlugify:
    def test_basic(self):
        assert slugify("Call Rapali About Invoice") == "call-rapali-about-invoice"
...
class TestVaultRecordPath:
    ...
    def test_date_path_with_explicit_date(self, mock_config):
        ...
        result = vault_record_path("task", "Call Rapali About Invoice", created=dt)
        assert result == "task/2026/03/02/call-rapali-about-invoice.md"
