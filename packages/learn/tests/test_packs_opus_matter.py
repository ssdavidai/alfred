...
def _sample_onboard() -> dict:
    return {
        ...
        "facts": [
            {"category": "professional", "fact": "Runs Example LLC", "confidence": "high"},
            {"category": "professional", "fact": "Building Alfred Black", "confidence": "high"},
            {"category": "personal", "fact": "Partner is Sam Lee", "confidence": "high"},
            {"category": "personal", "fact": "Daughter Robin, 6 months old", "confidence": "high"},
    ...
    "matters": [
        {
            ...
            "key_people": ["Pat (advisor)", "Sam Lee (partner)"],
        ...
        {
            "name": "Robin nursery logistics",
            "category": "logistics",
            "status": "active",
            "description": "Ongoing daily logistics around daughter Robin's nursery and care.",
            "context": (
                "Sir and Sam Lee coordinate daily care for Robin (6 months old). "
...
class TestBuildMatterPrompt:
    def test_prompt_contains_facts(self):
        facts = [{"category": "work", "fact": "Runs Example LLC"}]
        prompt = _build_matter_prompt(facts, [], [], {}, "")
        assert "Runs Example LLC" in prompt
    ...
    def test_prompt_contains_identity(self):
        identity = [{"field": "name", "display": "Full name", "value": "Sir"}]
