...
def _sample_onboard() -> dict:
    return {
        "facts": [
            {"category": "professional", "fact": "Inner circle: Pat, Sam Lee, tenant-a"},
            {"category": "personal", "fact": "Has newborn Robin"},
        ],
        "patterns": [
        ...
        "matters_brief": [{"name": "Pat collaboration"}],
    }
    ...
    "instincts": [
        {
            ...
            "rationale": (
                "Sir is in active cash flow management mode — multiple recent emails show "
            ...
            "examples": [
                "stripe.com: Payment failed for invoice INV-2024-038 — Sir rebooked it within 30 min last time",
        ...
        },
        {
            ...
            "rationale": (
                "Pattern newsletter-batch-reads shows Sir reads newsletters in the evening "
            ...
            "examples": [
                "example.com weekly digest goes straight to evening batch",
                "stratechery.com posts batched, not surfaced live",
            ],
            "input_patterns": {
                "sender_domains": ["example.com", "stratechery.com", "every.to"],
                "subject_keywords": [],
                "input_types": ["email"],
            },
            "routing_rule": {
...
class TestBuildRichInstinctContent:
    def _good(self):
        return {
            ...
            "examples": ["Sam Lee: any email", "Pat: contract revisions"],
