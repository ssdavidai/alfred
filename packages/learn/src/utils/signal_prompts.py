...
FEW_SHOT_EXAMPLES: list[tuple[dict[str, Any], dict[str, Any]]] = [
    ...
    # 2. Real — gmail repeated payment failure from Tella.
    ...
    #    obviously about Tella billing, so target_hint is descriptive
    #    and target_confidence stays modest.
    (
        {
            "source_type": "gmail",
            "frontmatter": {
                "from": '"Tella HQ Inc." <failed-payments@tella.tv>',
                "subject": "$26.00 payment to Tella HQ Inc. was unsuccessful again",
            },
            "body": (
            ...
            "raw_quote": (
                "$26.00 payment to Tella HQ Inc. was unsuccessful again — "
                "We weren't able to charge the credit card you provided."
            ),
        },
        {
            ...
            "mutation_proposal": None,
            "action_proposal": {
                "what": "Update Tella payment method or cancel the subscription",
    ...
    (
        {
            "source_type": "gmail",
            "frontmatter": {
                "from": '"Móricz Medical Kft." <villanyi.medical@szamlazz.hu>',
            ...
            "raw_quote": (
                "Móricz Medical Kft. — A rendelőnk most az Ön "
        ...
        },
        {
            ...
            "mutation_proposal": None,
            "action_proposal": {
                "what": "Pay the Móricz Medical invoice by the stated deadline",
    ...
    (
        {
            ...
            "body": "What's on my plate today? Anything urgent for the Móricz invoice?",
            "raw_quote": "What's on my plate today? Anything urgent for the Móricz invoice?",
        },
        {
            "classification": None,
            "effect": "none",
    ...
    (
        {
            "source_type": "plane",
            "frontmatter": {
                "name": "Plane: ALFRED-200 reassigned to David",
            },
            "body": (
                "Plane issue ALFRED-200: 'Configure CloudFront for "
                "assets' reassigned from Anna Kovács to David "
                "Szabo-Stuban. Priority: high. Due: Friday May 9, 2026."
            ),
            "raw_quote": (
                "Plane issue ALFRED-200 reassigned from Anna Kovács to "
                "David Szabo-Stuban — priority high, due Friday May 9"
            ),
        },
        {
            "classification": None,
    ...
    (
        {
            "source_type": "gcal",
            "frontmatter": {
                "name": "Strategy review w/ Sergii",
            },
            "body": (
                "Event: Strategy review w/ Sergii. Time: Mon May 12, "
                "2026, 4:00pm-5:00pm CEST. Attendees: "
                "david@szabostuban.com, sergii@partner.io, "
                "anna@lumberjack.so. Status: not yet responded. "
                "Description: Quarterly strategy alignment."
            ),
            "raw_quote": (
                "Strategy review w/ Sergii — Mon May 12 4-5pm CEST, "
                "attendees include Sir, Sergii, Anna; Sir has not yet "
                "responded"
            ),
        },
        {
            ...
            "effect": "action",
            "target_kind": None,
            "target_hint": "RSVP to strategy review with Sergii May 12",
            "mutation_proposal": None,
            "action_proposal": {
                "what": (
    ...
    (
        ...
        },
        {
            ...
            "mutation_proposal": {
                ...
                "details": (
                    "Sir says the Hetzner billing dispute is resolved "
...
_SOURCE_FRAMES: dict[str, str] = {
    "gmail": (
        ...
        "user (david@szabostuban.com, david@sabo.tech, alfred@lumberjack.so); "
    ...
    "vexa": (
        ...
        "in-meeting decisions ('let's drop Sembly', 'that task is "
...
def build_signal_extraction_prompt_multi(
  ...
  "effect_confidence": 0.0,
  "reasoning": "<1-3 sentences explaining your call>",
  "display_headline": "<Alfred's one-line headline for Sir's desk, in Alfred's voice>",
  "display_body": "<Alfred's 1-2 sentence framing: what happened, what he'd suggest. In Alfred's voice.>"
}"""
    ...
    schema_rules = (
        ...
        "strings written in Alfred's voice (see Section 4.5).\n"
    ...
    voice_block = (
        "## 4.5 Alfred's voice for `display_headline` and `display_body`\n\n"
        "These two fields per signal are the only thing Sir sees on his "
        "Today screen. Everything else in the JSON is plumbing. Write "
        "them as Alfred would — grounded in SOUL.md:\n\n"
        "- **Genuinely helpful, not performatively helpful.** No "
        '"Great question!", no "Here\'s what I found:", no apologies '
        "for the obvious. Skip filler. Go straight to the point.\n"
        "- **Have an opinion.** Don't list options when one is "
