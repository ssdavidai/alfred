...
Pipeline:
  ...
  3.  Agglomerative clustering on cosine distance with a fixed
      ...
      "BUDAORS TESCO" collapse into one group; "Wolt" stays separate.
...
DEFAULT_CATEGORY_RULES: list[tuple[str, str, str | None, str]] = [
    ...
    # Internal transfers — Wise, Revolut, Erste, Apple/Google Pay
    ...
    # Self-name transfers (Hungarian variations of "David/Eszter Szabó-Stubán")
    ...
    # Cashback/balance lines (Revolut interest, top-ups, balance adjustments)
