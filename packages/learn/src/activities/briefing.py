...
def _build_composition_prompt(
    *,
    ...
    lines.extend([
        ...
        "- WIKILINKS — PERSON NAMES TOO. Whenever you mention a person by",
        "  name (whether they have a vault person record or not — the",
        "  renderer resolves), wrap the name in [[Person Name]] wikilinks.",
        "  Examples:",
        "    Yes:  [[Brennan Sweeney]] is waiting on your RSVP for a",
        "          Fireroad call.",
        "    No:   Brennan Sweeney is waiting on your RSVP for a Fireroad",
        "          call.",
        "  Same name in two sections counts as the same person — the",
        "  renderer will dedup them by wikilink. Use the full canonical",
        "  name (first + last, no honorifics) so the wikilink is",
