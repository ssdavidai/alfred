  ...
  },
  {
    ...
    inputSchema: z.object({
      workflow_type: z.string().min(1).describe(
        "Registered workflow class name. Common ones on alfred-learn: OnboardingPipelineWorkflow, BriefingWorkflow, EventProcessorWorkflow, ReflectionWorkflow, TaskRunnerWorkflow. (`DailyDigestWorkflow`, `DailyMorningBriefingWorkflow`, and `DailyEveningDigestWorkflow` were deleted in commit f20556d and folded into `BriefingWorkflow`.)",
      ),
