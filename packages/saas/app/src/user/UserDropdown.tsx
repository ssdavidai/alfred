    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <button className="text-foreground hover:text-primary flex items-center transition-colors duration-300 ease-in-out">
          <span className="mr-2 hidden text-right font-mono text-xs font-light uppercase tracking-wider text-foreground/80 lg:block">
            {user.username}
          </span>
          ...
          return (
            <DropdownMenuItem key={item.name}>
              <WaspRouterLink
                ...
                className="flex w-full items-center gap-3 text-[#E8E4DE]"
              >
