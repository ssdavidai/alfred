  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="border-border bg-card rounded-sm border shadow">
        ...
        <div className="border-border py-4.5 grid grid-cols-10 border-t-4 px-4 md:px-6">
        ...
        {!!data?.users &&
          ...
          data.users.map((user) => (
            <div
              key={user.id}
              className="py-4.5 grid grid-cols-10 gap-4 px-4 md:px-6"
            >
              <div className="col-span-3 flex items-center">
              ...
              <div className="col-span-1 flex items-center">
                {user.instance ? (
                  <Link
                    ...
                    params={{ instanceId: user.instance.id }}
                    className={`inline-block rounded-full px-2 py-0.5 text-xs font-medium ${
                      user.instance.status === "running"
                        ? "bg-green-900 text-green-200"
                        : user.instance.status === "error"
                          ? "bg-red-900 text-red-200"
                          : user.instance.status === "provisioning"
