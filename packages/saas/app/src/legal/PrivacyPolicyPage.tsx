    ...
    <div className="paper min-h-screen" style={{ color: "var(--ink)" }}>
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 font-body text-[16px] leading-[1.65]">
          ...
          <section>
            <p>This Privacy Policy describes how <strong>Ugly Code LLC</strong> ("Company," "we," "us," or "our"), operator of Alfred Black, collects, uses, stores, and shares information about you when you use our website at alfred.black and our AI butler service (collectively, the "Service").</p>
