      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 font-body text-[16px] leading-[1.65]">
          ...
          <section>
            ...
            <p>These Terms of Service ("Terms") govern your access to and use of Alfred Black, operated by <strong>Ugly Code LLC</strong>, 28 Geary St STE 650 Suite #142, San Francisco, California 94108, United States ("Company," "we," "us," or "our").</p>
          ...
          <section>
            ...
            <div className="mt-3" style={{ color: "var(--marginalia)" }}>
              <p><strong>Ugly Code LLC</strong></p>
