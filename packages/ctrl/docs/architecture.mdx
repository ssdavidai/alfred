...
Every Alfred instance runs on its own Acme Cloud VPS. Data is encrypted at rest with LUKS2 (AES-256-XTS). All services bind to localhost — zero public ports. External access is exclusively through your Tailscale mesh network, which provides end-to-end WireGuard encryption.
