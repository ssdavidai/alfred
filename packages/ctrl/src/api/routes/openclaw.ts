...
// on a cx53 Acme Cloud VPS; 60s gives us comfortable headroom.
...
const MCP_SERVER_TOOLS: Record<string, Array<{ name: string; description: string; prime_only: boolean }>> = {
  "alfred-ctrl": [
    ...
    },
    {
      name: "tenant",
      description:
        "Call a peer tenant's ctrl-api over Tailscale. Alfred Prime only — lets Sir operate on tenant-b/tenant-a/other tenants.",
      prime_only: true,
    },
    {
      name: "ask_alfred",
