  ...
  inputSchema: {
    ...
    properties: {
      tenant: {
        type: "string",
        description:
          "Peer tenant id (e.g. \"miguel\", \"rapali\"). Use the alfred-prime-federation skill's peer list.",
      },
      endpoint: {
        type: "string",
