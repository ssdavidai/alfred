...
/** Mute Alfred-in-meeting on a live Recall bot (#113 PR5). Pauses
 *  the wake-word→speak loop without dropping the WS subscriber; the
 ...
 *  upload to Recall so the bot speaks the line into the meeting. Used
 *  by the RecallCard live-bots section. */
 ...
 *  query polls a non-SSE companion. We approximate by reading the
 *  last fragments via a normal GET; the dashboard polls at 2s. */
