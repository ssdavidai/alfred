...
export async function provisionInstanceJob(
  ...
  try {
    ...
    // Try multiple Acme Cloud locations in order of preference.
    ...
    // but the SaaS Acme Cloud project's dedicated_core_limit was already
    ...
    // alfred-ctrl's destroy() handles already-gone Acme Cloud resources
